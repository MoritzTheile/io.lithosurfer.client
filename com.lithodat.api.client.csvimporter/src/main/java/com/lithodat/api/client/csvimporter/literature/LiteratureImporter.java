package com.lithodat.api.client.csvimporter.literature;
...
public class LiteratureImporter {
	...
	public LiteratureImporter(String jwtToken, String endpoint) {
		...
		this.url = endpoint + "/api/literature";
	}

	public void upload(LiteratureDTO literatureDTO) throws Exception {
